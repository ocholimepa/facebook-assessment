...
List<Post> posts = [
  new Post(
      profileImageUrl: 'assets/ocholi.JPG',
      username: 'Ocholi Mepa',
      time: '5h',
      content:
      ...
      shares: '2'),
  new Post(
      profileImageUrl: 'assets/samuel.JPG',
      username: 'Samuel',
      time: '13h',
      content:
      ...
      shares: '6'),
  new Post(
      profileImageUrl: 'assets/mama.JPG',
      username: 'Mama Peace',
      time: '2d',
      content:
      ...
      shares: '2'),
  new Post(
      profileImageUrl: 'assets/chidinma.JPG',
      username: 'Chidinma',
      time: '1w',
      content:
      ...
      shares: '4'),
  new Post(
      profileImageUrl: 'assets/mepa.JPEG',
      username: 'Mepa Samuel',
      time: '3w',
      content:
